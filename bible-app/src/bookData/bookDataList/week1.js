export const weekOne = {
  ...
  5. The Tower of Babel (Chaps. 11): All men on earth joined in rebellion against God. So, God confused their language, and scattered the human race throughout the earth. The different languages as we have them today came because God dealt with the ungodly ambition in man.
    ...
    partTwo: {
      ...
      • What are the promises given to Abraham based on his Obedience to divine command (12/1 - 3) ? God gave His covenant to Abraham, Isaac and Jacob (Acts 7:32). What is the Covenant (12:1-3; 26:1-5;28:13-15)?
      ...
      Who was the principal character in 27:1-37:2a? . Read 32:22-32. In what ways was the Peniel experience a spiritual turning point in Jacob's career? Any lessons for us? • In your own words, what is the theme of the book of Genesis?
      `
    }
  },
...
export const weekTwo = {
  ...
  discussion: {
    ...
    name: 'Discussion',
    partOne: {
      name: 'THE NEED FOR DELIVERANCE How does Exod. 1:1-7 fulfil Gen. 12:2a?',
      content: `Obviously, jealousy, envy and hatred regarding the geometric multiplication of the children of Israel (Exod. 1:17) made the Egyptians to subject them to hard bondage (1:8-14).

    • How does this relate to how the Church has been persecuted by the world, right from the Acts of the Apostles Compare Jn. 10:10 with what happened in Exod. 1:15-22. Exod. 2:23-25 underscores the very theme of Exodus-deliverance.
    ...
    partThree: {
      name: `THE REDEMPTION IS ENHANCED`,
      content: `God didn't just deliver Israel from Egypt, but also gave them His constitution, the Law (19:1-24:11), to guide their lives and living. What is the place of God's Word in Christian living (Jos. 1:8; 2 Tim. 3:16-17)? God also gave them the tabernacle as place of regular

      meeting fellowship with Him (24:12-31:18; 35-40) and with one another (Heb. 10:25) What importance does God attach to fellowship with Him and the brethren (Heb. 10:25; cf. Acts 2:42ff)?
      
      We see the way God dealt with Israel when they broke the covenant
      
      (32:1-34:35). What is God's attitude to sin among the redeemed, today.`
    }
  },
...
export const weekThree = {
  ...
  discussion: {
    title: 'An Overview Of The Book Of Leviticus',
    name: 'Discussion',
    content: `Leviticus prescribes on how God wants to be worshipped. The LORD God is holy and must be approached in holiness and with true worship. Read John 4:24 and Romans 12:1-3. Describe the best way the believer in Christ can worship and serve God. Chaps 1-7: Worshipping God cannot be done anyhow. God specifies beginning from 1:1, describing the offerings and how to make them. 
      
    The sacrifices foreshadow Christ (Heb. 9:9). Chaps 8-10: Aaron and his sons were consecrated before they could do their priestly duties. God doesn't use any vessel that He hasn't first consecrated for His holy use.
    
    Aaron's sons who didn't keep to their consecration terms were divinely struck dead (10:1). Explain some of the things that can constitute strange fire on the altar, today. Chaps. 11-15: God is holy, and His people must be holy (cf. Matt. 5:48; 1 Pet. 1:14-16). He specifically warned them against defilement, to remain holy unto Him.
    
    16:6-17: Atonement is another strong theme in Leviticus. Despite the consecration of His people, God still set apart a day of Atonement (Yom Kippur) when they must atone for their sins, to remove the guilt of sin. Christ has perfected this, once and for all (Heb.9:23). 17:11ff describes the sanctity of blood. Compare this with Heb. 9:22 in the light of Gen. 3:21. What is the place of blood in Redemption?
    
    How can the believer achieve consecration and sanctification today when the blood of goats, rams and cattle are no longer of any effect, because of Christ's perfect sacrifice? It is only gentiles that still sacrifice (1 Cor. 10; 19:2) 18:1ff. God proscribed some sexual practices for His people. Never learn or join with the practices of the heathen. • 23:1ff: God permitted some feasts among His people: Sabbath, Passover, Unleavened bread, First fruits, Feast of Weeks, Trumpets, and Day of Atonement. What are significances of some of the holy feasts that the Israelites kept and how relevant are they to us today? God now wants true worshippers (John 4:21-24)`,
  },
  conclusion: {
    title: 'An Overview Of The Book Of Leviticus',
    name: 'Conclusion',
...
export const weekFour = {
  ...
  discussion: {
    title: 'An Overview Of The Book Of Numbers',
    name: 'Discussion',
    content: `Chaps 1-6: Proper preparation is imperative (cf. Lk. 14:28). Israel prepared for the journey to the Promised Land (Num. 1:1-10:10). To show the imperativeness of stock-taking and accountability, God instructed Moses to take a census of the entire Israelites (1:1-2) and later the Levites (3:14) The most famous passage in Numbers is the Priestly Blessing in 6:24-26

    How significant is that to Christians today? Chaps. 11-21: A lack of an experiential knowledge of God usually brings disaster (cf. Dan. 11:32b). How did that affect Miriam, Aaron and the people themselves (Num. 10:11-14:45)? In Numbers 11, compare verses 1, 10, and 33. What made the Lord so angry? Do you think the same thing makes Him angry today? For 40 years, the people wandered in the desert until the faithless generation was consumed (15:1-21:35). Faithlessness robs believers of their God-given prosperity (cf. 2 Chro. 20:20). 
    
    What did Moses do wrong in 20:1-13, despite being the meekest (12:3)?
    Do you think his punishment is too severe? Why?
    
    Chap. 22-25: God frustrated the conspiracy of King Balak and Balaam, a local sorcerer and prophet, against Israel. What finished the people-Balak-Balaam conspiracy or their own sin (23:23;25:1ff)? What Satan cannot do in a believer's life, SIN can do it. Chaps 26,27: Moses organised an army, and commissioned Joshua to succeed him. God gave them instructions on offerings and feasts (Num. 26:1-30:16; Lk. 14:31). Why the problem of succession today?
...
export const weekFive = {
  ...
  discussion: {
    ...
    ii. The Covenant (4:23) iii. The past slavery (5:15)
    
    iv. The great deliverance (7:18) V. The divine leadership and supplies (8:2-6)
    
    vi. The sins of the past (9:7) vii. The divine judgement (24:9) viii. The ancient days (32:7) Commands to Follow: The Ten Commandments are meant for God's people to obey, to enjoy God's benevolence meant for them. The chief of these commands is love for the only One and True God (5:7). Promises: God's promises for His people are most times conditional; hinged on loyalty, obedience and faithfulness (chaps 27, 28). The Three Speeches of Moses hinge on 1. What God has done for Israel (1:1-4:43),
    
    2. What God expects from Israel (4:44-26:19), 3. What God will do for Israel (27:1-43:12).
...
export const weekSix = {
  ...
  discussion: {
    ...
    God gave Moses a staff, but gave Joshua the Word. What are the implications of God's injunction to Joshua in 1:6-8 for us today? Going through the book of Joshua, we see that Joshua followed God's leading: he took up the challenge; sent spies and led the people across the Jordan into the promised land of Canaan. Do you see that as the secret of Joshua's success? How obedient are you to the Lord's directives in the assignments He gives you?
    
    Draw lessons from the faithfulness of Rehab the harlot (2:1-12). What gave the people of God victory in battle of Jericho (6:1-27)?
    ...
    . What can we learn from Joshua's mistake in entering into treaty with the Gibeonites without God's consent, and his attitude when he discovered the mistake thereafter (9:1-27; cf. 2 Sam. 21:1ff)? What do you know about Caleb the warrior? What was his relationship with Joshua (13:6,30; 14:16-14)? • It is glaring from Joshua that our God is the ultimate promise Keeper who keeps His promises and covenants right from generation to generation (cf. Num. 23:19).
    
    . As long as we abide by and follow God's commands, we are sure of experiencing divinely orchestrated victory and blessings (cf. Deut.
    
    28:1ff). Just as Joshua watched Moses and learnt from him, someone is also watching and learning from you. People believe and love to learn from your lifestyle than what you teach or say. So, watch your life and doctrine lest you mislead others (cf. 1 Tim. 4:16).`
...
export const weekSeven = {
  ...
  discussion: {
    ...
    How did it happen? How did things get that worse? (cf. Jdg. 2:10; 7:4). Disobedience was the major error here, that God wanted us to avoid; it brought judgement. The Israelites plunged into disobedience, the more God's wrath fell on them, because the Lord disciplines those he loves, and he punishes everyone he accepts as a son (Heb. 12:6).
...
export const weekEight = {
  ...
  discussion: {
    title: 'An Overview Of The Book Of Ruth',
    name: 'Discussion',
    content: `The book of Ruth traces the lineage of Ruth to David. Compare Matthew 1:1-5 and Ruth 4:17-22 to see how that fulfils the Davidic ancestry of Jesus Christ. That a foreigner, even a Moabitess, can be linked with Israel's blessing is an attestation to the beauty of God's grace. (Mt 1:5; Ruth 4:17-22).
...
export const weekNine = {
  ...
  discussion: {
    title: 'An Overview Of The Book Of Samuel',
    name: 'Discussion',
    content: `How does I Sam. 2:1-10 show the main message of the books of Samuel as the Lord's sovereignty and faithfulness towards His people, even when they fail? 1 Sam. 1-7: Israel found herself in a spiritual mess. Their leaders had failed and God's presence had departed (1 Sam. 2:12-11-17, 22-26; 4:37:2). What is the case with churches today? 1 Sam. 8-15: Israel willingly/deliberately shut their hearts against spiritual and divine reasoning/wisdom, and God yielded to their unguarded desires (8:1ff). What are the dangers of permissive divine will? 1 Sam. 16-2 Sam. 6: The sovereignty of God laced with love, foresight and holiness later overruled Israel's carnal desire, choice and approval of ungodliness and oppression in the name of a king; He chose David instead. Does God still do that today (Psa. 75:6)?
    
    Saul moved from humility to pride; stewardship to oppression, and ultimately, to murder, and eventually wasted himself and his throne. 2 Sam. 7-24: David moved from farm to palace, from palace to wilderness and back to palace. He patiently and maturely waited for God's promise. What message does that send to upcoming leaders? Read 1 Sam. 2 and 2 Sam. 22. How do these portray a major theme expounded in Samuel-the promise of a Messiah?`
  },
...
export const weekTen = {
  ...
  discussion: {
    ...
    heart, showed good example, which later on became a yardstick for Go with which He measured the performances of all the kings that ruled both Judah and Israel (1 Kgs 15:4,5). 2:12-11:43: How did the divided heart of an apostatising king result in a divided kingdom of Israel? How is that happening today?
    ...
    Read 1 Kgs. 14:8; 15:3ff; 16:2, 19; 22:52; 2 Kgs. 3:3; 14:3; 16:2. Both David and Jeroboam became points of reference in Israel. How did God rate and judge them and their legacies? Way of Jeroboam: This phrase cuts across the books of kings and it describes the terrible reign of Jeroboam characterised by pervasion, idolatry and all forms of godlessness. Many kings followed his evil legacy (1 Kgs 15:26,34; 16:2,19,26,31-34; 2 Kgs 8:27; 9:9; 10:29; 13:6,11; 14:24; 15:9,18,24, 28; 16:3).
...
export const weekEleven = {
  ...
  discussion: {
    ...
    . It is a grievous thing to neglect God. From the following scriptures, highlight some of the consequences of forsaking God (1 Chron. 10:1-14; 2 Chron. 13:1-16; 16:12; 18:33-34; 20:12; 21:15-19; 24:20; 25:14-24; 26:19-20; 28:1-5; 33:1-11). What of those who seek Him well (2 Chron. 12:14, 16:12, 20:1-30, 30:1-27, 31:20-21)? God is seeking for true worshippers (II Chro. 16:9 Jhn. 4:21-24) Jesus is prefigured in Chronicles as the One coming to fully and ultimately establish the throne of David forever (Matt. 1:1-17, Luke 3:23-38).
    `
  },
...
export const weekTwelve = {
  ...
  introduction: {
    ...
    title: `An Overview Of The Book Of Ezra-Nehemiah`,
    name: `Introduction`,
  ...
  discussion: {
    title: 'An Overview Of The Book Of Ezra-Nehemiah',
    name: 'Discussion',
    content: `As Ezra-Nehemiah set out to provide a record of the reconstruction of the Hebrew theocracy upon the physical and spiritual foundations of the past, and emphasise covenant renewal in the restored community (cf. Neh. 8-10), the key messages are the power of God's Word in human life, and the building of the walls as a type of building the Divine Kingdom on Earth (Ezr. 1:1;9:4). God's superintendence shows that God will fulfil His promises to restore His people, however broken down they appear; He uses anybody whoever he/she is-Cyrus, Darius, Artarxerxes, Ezra, Nehemiah, Zerubbabel, etc. Conviction. The people wept because they were convicted by divine messages that aroused their conscience for a change. The messages were to reconstruct their Jewish life and be de-robed of all foreign attire (Ezr.9:2). Exogamy (marrying outside their people's own social group) was, and remains a sin among God's people. Intermarriage with non-lewish or foreigner was a sin which they restituted (Ezr. 10:2,3) .
    ...
    • The institution of the temple, installation of its officers, and the emphasis of the Law portray the historical and theological continuity between the pre-exilic and postexilic Israel. It proclaims the legitimacy of the restored community's religious, political, economic, and social life as God's people (cf. Neh. 9:32-37). Contrast in the books: While Cyrus, Darius and Artarxerxes were instruments in God's hands for these projects, the likes of Sanballat, Tobiah, and Geshem were devil's agents to stop them. Where do you stand?
    
    Jesus in Ezra-Nehemiah: The Lord of heaven and earth (Ezr. 1:2), the covenant-keeping God (Neh. 1:5). Who is Jesus in your family, work, business, etc.? There is no competition and individualism in God's business. Remember Zerubbabel, Ezra and Nehemiah. Each was called by God for different assignments amongst the SAME PEOPLE.
...
export const weekThirteen = {
  ...
  discussion: {
    ...
    • Haman's anger against Mordecai, and by extension the entire Jews is a demonstration of the passionate hatred of the devil and his hosts against the Gospel (3:1-6). But He has always failed (cf. Rom. 16:20). God places mentors in our lives to teach wisdom. Mordecai proved to be a wonderful God-sent mentor and parent to Esther.
    
    It is evident from the book that God is the only One who turns trials to blessings (4:14). Our prayers and voice matter to Him, and He answers accordingly, God is able to bring great favour and blessing on our ways, even in hard situation (5:1-3). How does King Ahasuerus's wrath against Haman teach us about w rath against our sin (In. 3:18; Rom. 1:8; 5:8-10)? When Mordecai heard the edict, he tore his clothes and clothed himsel in sackcloth and ashes. What's your response to seeing injustice and evil around you? What can Mordecai's response to injustice and evil teach us about our own? God`
  },
...
export const weekFourteen = {
  ...
  discussion: {
    title: 'An Overview Of The Book Of Job',
    name: 'Discussion',
    content: `It is most probable that Job lived during the time of the patriarchs. Note that the book doesn't mention the Law of Moses like it referred to a flood (22:16). Also, in the manner of Abraham (Gen 12:7), Job functions as a priest in offering sacrifices for his family (1:5). Added to the fact that Job's longevity is typical of the patriarchs (42:16; cf. Gen 11:22-26,32). Rather than answer the age-long question, "Why does God allow the righteous to suffer?" that Job himself never received a direct answer, the book answers the question, "How should the righteous suffer?" Though he is never told of Satan's challenge, "'Does Job fear God for nothing? God allowed job to suffer in answer to that challenge. Read Jas. 5:11. The book paints a beautiful picture of "patience" which means to maintain fidelity to God, even under great trials, whether we understand what is happening, or not. The book shows us how the righteous should bear up under suffering. Job came close to charging God with wrong, yet he never crossed the line, but humbly submitted to God when told that the answers to his questions are beyond his ability to understand.
    
    The book defends God's absolute glory and perfection (cf. Psa. 18:3). We must praise God for who He is, apart from the blessings He bestows. Satan denied this (1:9-11), but Job proved him wrong (1:20-22;2:10). Though we can't tie all the "loose ends" of the Lord's purposes together because His workings are beyond man's ability to fathom (cf. Psa. 115:3),
    
    we must learn to trust in Him, no matter the conditions. God shows in the book that suffering isn't always the result of personal sin, but may be allowed as a compliment to one's spirituality, to silence Job's friends erroneous conclusion. God allowed Job to suffer to prove to Satan what kind of man he really is. Does God have such confidence in You?
    
    • The book also prefigures the coming of Christ: ✓9:33; 33:23; cf. 1 Tim. 2:5 ✓19:25; cf. Eph. 1:7`
  },
...
export const weekFifteen = {
  ...
  discussion: {
    ...
    partOne: {
      ...
      content: `Psalms of praise Individual praise (9; 18; 32:34:116; 138); Communal praise (6812) 67; HIS; 113, 124, 129, 136); Praise for the God of nature (19,29 650-13:102.25-27;148); and Praise for God's kingship (47:93:96-99) Royal, Messianic psalms (2; 18; 20; 21:45;61,72:89; 101: 110; 132: 144) 
      Passion psalms (16; 22; 40;69: 102; 109). 
      Laments: National (14: 44; 58; 60; 74; 80; 83; 106; 125); and Individual (13:5-6;22:1-21:28:1-9).
      Imprecatory psalms (e.g., 74:10; 109:21). Penitential psalms (6; 32; 38;51; 102; 130; 143).
    ...
    partTwo: {
      ...
      content: `Read Psa. 25:8, 10; 63:2-3. Identify the character of God, i.e. some of the attributes of God frequently extolled in the psalms. Psa. 2; 96-99; 110 show the idea of the concept of God's ruling on the earth in justice and righteousness-the Kingdom of God?
...
export const weekSixteen = {
  ...
  introduction: {
    ...
    title: `An Overview Of The Book Of Proverbs And Ecclesiastics`,
    name: `Introduction`,
  ...
  discussion: {
    title: 'An Overview Of The Book Of Proverbs And Ecclesiastics',
    name: 'Discussion',
    content: `The book of Proverbs can be broadly divided into three: 
    ...
    What is the portion of sinners in the land of the living (2:26)? In view of Eccl. 8:12; 12:13, what is the duty of man as regards his relationship with God? Everyone has to FEAR God and consequently be assisted to love and desire to do His will (Ps. 110:10)
...
export const weekEighteen = {
  ...
  discussion: {
    ...
    1:2; 5:1-7: God expressed His disappointment in His people's rebellion the sovereign One seated on a throne, high and exalted (6:1,5). and failure (v. 2: 5:1ff). Sin dullens the sensitivity and productivity of anyone who allows himself to be entangled by it, just like the people of Judah (5:1ff). 
    ...
    • 45:1-5: One of Isaiah's most remarkable prophecies was the naming of Cyrus, king of Persia, the ruler who would conquer the Babylonians and release Israel from exile (cf. 44:28). The prophecy was fulfilled when, along with the Medes (cf. 13:17), Cyrus won several important victories before sending his troops against Babylon. Isaiah presented him as one anointed by the LORD to bring deliverance for Israel. Chaps 55-66: God is the God of all flesh, and wishes that all come to His knowledge (cf. 55:1). Everyone... includes both the Jews and Gentiles in God's programme (56:1ff; 65:1). 
...
export const weekNineteen = {
  ...
  introduction: {
    ...
    title: `An Overview Of The Book Of Jeremiah And Lamentations`,
    name: `Introduction`,
  ...
  discussion: {
    ...
    Chaps 39-52: As the LORD said, Jerusalem was invaded (chap 39) by the Babylonians, and Jeremiah was freed. Philistia, Moab, Elam and even
    
    Babylon didn't escape God's just judgement. . Lam. 1-4: Lamentations' reveals Judah's pathetic state following the Babylonian conquest occasioned by their recalcitrance. It gives insight into the pain and sorrow that can accompany unrepentance.
